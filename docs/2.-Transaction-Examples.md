...
```javascript
const { Api, JsonRpc } = require('gosj');
const { JsSignatureProvider } = require('gosj/dist/gosj-jssig');  // development only
...
```javascript
import { Api, JsonRpc } from 'gosj';
import { JsSignatureProvider } from 'gosj/dist/gosj-jssig';  // development only
